...
type Repository interface {
	...
	FindAllInTrashByUserID(ctx context.Context, userID string) ([]*Content, error)
	Restore(ctx context.Context, userID string, contentID string) (*Content, error)
	PermanentDelete(ctx context.Context, userID string, contentID string) (orphanFileIDs []string, err error)
}
